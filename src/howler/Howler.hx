...
extern class Howler {
     ...
     */
    static function pos(x:Float, y:Float, z:Float):EitherType<HowlerSpatial, Array<Float>>;
    ...
    */
    static function orientation(x:Float, y:Float, z:Float, xUp:Float, yUp:Float, zUp:Float):EitherType<HowlerSpatial, Array<Float>>;
}